  ...
  return (
    ...
    >
      ...
      <Text
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Copyright @ 10XSHORTS 2023"
        {...getOverrideProps(overrides, "Copyright @ 10XSHORTS 2023")}
      ></Text>
      <Flex
        gap="24px"
        direction="row"
      ...
      >
        <Text
          ...
          whiteSpace="pre-wrap"
          children="10XSHORTS"
          {...getOverrideProps(overrides, "10XSHORTS")}
        ></Text>
        <Text
          fontFamily="My Font"
          fontSize="16px"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Create scroll stopping short videos with AI"
          {...getOverrideProps(
            overrides,
            "Create scroll stopping short videos with AI"
          )}
        ></Text>
      </Flex>
    </View>
