...
export default function ProjectsCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setUpdatedDate(initialValues.updatedDate);
    setCreatedDate(initialValues.createdDate);
    setRawVideoURL(initialValues.rawVideoURL);
    setSubtitleURL(initialValues.subtitleURL);
    setSettingURL(initialValues.settingURL);
    setErrors({});
  };
  const validations = {
    name: [],
